...
namespace Versioned_MovieServiceExample
{
    [TestClass]
    public class MovieServiceExample
    {
        ...
        public void Initialize()
        {
            ...
            {
                new Discount { Id = 1, MovieDiscount = 5, MovieId = 1, UserId = 3, Enabled = false, },
            ...
            Rules = new VersionedFactRuleCollection
            {
                ...
                (Version2019 _, UserEmailFact fact) => new UserFact(UserDB.Single(user => user.Email == fact.Value)),

                // If we have a movie ID, you can find a movie.
                (Version2019 _, MovieIdFact fact) => new MovieFact(MovieDB.Single(movie => movie.Id == fact.Value)),

                // If we have a movie, you can find a movie ID.
                (Version2019 _, MovieFact fact) => new MovieIdFact(fact.Value.Id),
                ...
                (Version2019 _, MovieFact movieFact, MovieDiscountFact movieDiscountFact) => new MoviePurchasePriceFact(movieFact.Value.Cost - movieDiscountFact.Value),
            };
