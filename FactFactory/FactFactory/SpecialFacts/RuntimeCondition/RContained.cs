...
namespace GetcuReone.FactFactory.SpecialFacts.RuntimeCondition
{
    ...
    public class RContained<TFact> : BaseRuntimeConditionFact<TFact>
        where TFact : IFact
    {
        /// <summary>
        ...
        /// </summary>
        /// <inheritdoc/>
        public override bool Condition<TFactWork, TFactRule>(TFactWork factWork, IFactRulesContext<TFactRule> context)
        {
